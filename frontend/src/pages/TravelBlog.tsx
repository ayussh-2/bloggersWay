        ...
        <div>
            ...
            >
                <div className="w-1/2 flex flex-col items-baseline">
                    <h1 className="text-4xl font-lemonMed">Awesome Title</h1>
            ...
            >
                <h1 className="flex items-center gap-5 text-center">
                    ...
                    <span className="font-lato italic text-xl ">
                        Kiyomizu-dera Temple, Arashiyama Bamboo Grove, Artistic
                        Heritage in Gion
                    </span>
                </h1>
            </motion.div>
            ...
            >
                ...
                <p className="text-lg font-poppins text-gray-500 mt-20 mb-40 w-[800px] text-center">
                    ...
                    Consectetur, similique! Consectetur doloribus laudantium
                    animi ut nam eius, excepturi accusamus, ipsum ducimus atque
                    minima nisi sit praesentium magni enim, dicta laboriosam.
                </p>
            </div>

            <div className="px-20 mb-40 flex flex-col items-start" id="route">
                ...
                <p className="font-poppins text-lg text-gray-500 my-10">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Aliquid odit nihil quisquam voluptatibus obcaecati ducimus
                    fuga amet, reprehenderit quidem quod facere laborum
                    repellat! Et dignissimos sunt laudantium magni delectus
                    praesentium! Lorem ipsum dolor sit, amet consectetur
                    adipisicing elit. Sapiente repellat consequuntur mollitia
                    nulla ducimus illum provident maiores, suscipit voluptatem
                    ratione laboriosam culpa aspernatur est, fugit quasi omnis
                    eveniet nemo qui.
                </p>
            </div>
            ...
            <div className="relative" id="end">
                <div className="overflow-hidden h-96">
                    <img
                        src="https://images.pexels.com/photos/12532792/pexels-photo-12532792.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                        alt=""
